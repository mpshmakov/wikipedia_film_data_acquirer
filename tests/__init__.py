...
class TestDatabaseOperations(unittest.TestCase):
    ...
    def test_initDB(self, mock_Session, mock_check_tables_exist, mock_initialize_schema):
    ...
    @patch('database.operations.check_tables_exist')
    @patch('database.operations.Session')
    def test_initDB_tables_not_exist(self, mock_Session, mock_check_tables_exist, mock_initialize_schema):
...
class TestWikipediaUUID(unittest.TestCase):
    ...
    def test_main(self, mock_exportToJson, mock_exportToCsv, mock_insertRow, mock_initDB, mock_scrape):
